...
** `docker run -it --rm -p 3000:3000 -e LOG_LEVEL=debug ghcr.io/osamahaltassan/ffmpeg-api:1.1`
...
** `docker run -it --rm -p 3000:3000 -e FILE_SIZE_LIMIT_BYTES=1048576 ghcr.io/osamahaltassan/ffmpeg-api:1.1`
...
** `docker run -it --rm -p 3000:3000 -e KEEP_ALL_FILES=true ghcr.io/osamahaltassan/ffmpeg-api:1.1`
...
** `docker run -it --rm -p 3001:3000 -e EXTERNAL_PORT=3001 ghcr.io/osamahaltassan/ffmpeg-api:1.1`
